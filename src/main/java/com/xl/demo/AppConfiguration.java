...
public class AppConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		additionalProperties.put("hibernate.validationQuery", env.getProperty("hibernate.validationQuery"));
		additionalProperties.put("hibernate.testOnBorrow", env.getProperty("hibernate.testOnBorrow"));
